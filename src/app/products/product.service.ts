...
export class ProductService {
  ...
  // * Since our selectedProductSource is private, this expose a read only observable from our subject
  ...
  */
  ...
  getProducts(): Observable<IProduct[]> {
    ...
    return this.http.get<IProduct[]>(this.productsUrl).pipe(
      ...
      // This will save the retrieved data into this.product array
